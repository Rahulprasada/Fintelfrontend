          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-xl text-gray-200 mb-8">
                Leverage cutting-edge artificial intelligence to identify
                investment opportunities and optimize your portfolio.
              </p>
              <Button
                size="lg"
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                  Our AI-powered platform gives you access to the same
                  sophisticated tools and data used by top hedge funds and asset
                  managers.
                </p>
              </div>
                      ...
                      <div className="col-span-12 lg:col-span-3">
                        <div className="space-y-4">
                          <div className="bg-finance-blue/5 dark:bg-blue-900/20 p-4 rounded-lg">
                            <h3 className="text-sm font-medium text-finance-blue dark:text-blue-300 mb-3">
                              AI Screener
                            </h3>
                          ...
                          <div className="bg-finance-blue/5 dark:bg-blue-900/20 p-4 rounded-lg">
                            ...
                            <div className="space-y-3">
                              {[
                                {
                                  text: "Unusual volume in tech sector",
                                  time: "10m ago",
                                },
                                {
                                  text: "New hedge fund 13F filings",
                                  time: "1h ago",
                                },
                                {
                                  text: "Smart money flow alert",
                                  time: "2h ago",
                                },
                                {
                      ...
                      <div className="col-span-12 lg:col-span-9">
                        <div className="space-y-6">
                          <div className="bg-white dark:bg-finance-gray/80 shadow p-4 rounded-lg">
                            <h3 className="text-lg font-medium text-finance-blue dark:text-white mb-3">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                              <div className="bg-gray-100 dark:bg-gray-800 p-3 rounded">
                                ...
                                <p className="text-lg font-bold text-finance-blue dark:text-white">
                                  87%
                                </p>
                              </div>
                              <div className="bg-gray-100 dark:bg-gray-800 p-3 rounded">
                                ...
                                {[
                                  ...
                                  <div key={risk.name} className="space-y-1">
                                    <div className="flex justify-between text-xs">
                                      ...
                                      <span className="text-finance-blue dark:text-blue-300">
                                        {risk.score}/100
                                      </span>
                                    </div>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p className="text-gray-600 dark:text-gray-300 text-lg">
                Our AI platform combines machine learning, natural language
                processing, and quantitative analysis to provide
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                {
                  icon: (
                    <Search className="h-10 w-10 text-finance-blue dark:text-blue-400" />
                  ),
                  title: "AI-Based Stock Screening",
                  description:
                    "Identify investment opportunities using predictive earnings models and Buffett-style intrinsic valuation techniques.",
                  features: [
                ...
                {
                  icon: (
                    <TrendingUp className="h-10 w-10 text-finance-green dark:text-green-400" />
                  ),
                  title: "Institutional Trading Activity",
                  description:
                    "Track smart money flows, unusual volume patterns, and institutional investor positions through 13F filings.",
                  features: [
                ...
                {
                  icon: (
                    <Shield className="h-10 w-10 text-finance-accent dark:text-purple-400" />
                  ),
                  title: "Portfolio Optimization",
                  description:
                    "Optimize your portfolio with advanced risk modeling, custom backtesting, and factor-based investing tools.",
                  features: [
                ...
                {
                  icon: (
                    <Database className="h-10 w-10 text-finance-gold dark:text-yellow-400" />
                  ),
                  title: "Alternative Data Analysis",
                  description:
                    "Incorporate alternative data sources including AI sentiment analysis, Google Trends, and sector correlations.",
                  features: [
                    "Sentiment analysis",
                    "Web search trends",
                ...
                <Card key={index} className="finance-card">
                  <CardHeader>
                    ...
                    <CardTitle className="text-xl font-bold text-finance-blue dark:text-white">
                      {feature.title}
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
                      ...
                      {feature.features.map((item, i) => (
                        <li key={i} className="flex items-start">
                          <span className="rounded-full bg-finance-blue/10 dark:bg-blue-900/30 p-1 mr-2 mt-0.5">
                            <svg
                              className="h-3 w-3 text-finance-blue dark:text-blue-400"
                              fill="none"
                              viewBox="0 0 24 24"
                              stroke="currentColor"
                            >
        ...
        <section className="py-20 finance-gradient">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-gray-200 mb-8">
                Join leading institutions that trust our AI-powered research
                platform to gain an edge in the market.
              </p>
