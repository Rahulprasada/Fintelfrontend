...
import { esgCompanies } from "./ESGData";
...
import { ESGCompanyScore } from "./ESGIntellegence";
import {
  esgControversies,
  esgDataSources,
  esgRisks,
...
function Sustainability({
  ...
  const handleExport = (format: string) => {
    toast.success(
      `Exporting ESG report in ${format} format for ${company.companyName}`
    );
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="relative flex items-center justify-center">
                <svg className="w-40 h-40">
                  ...
                  <circle
                    ...
                    strokeDashoffset={
                      Math.PI * 120 * (1 - company.overallScore / 100)
                    }
                    strokeLinecap="round"
        ...
        {/* Pillar Scores */}
        <Card className="col-span-1 md:col-span-2 border-l-8 border-l-red-100">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card
          ...
          style={{ background: "linear-gradient(to right, #e5face, #ffffff)" }}
        >
          <CardHeader className="pb-2">
            <CardTitle className="text-lg font-bold">ESG Score Trend</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        {/* Controversies */}
        <Card className="col-span-1"  style={{ background: "linear-gradient(to right, #f9face, #ffffff)" }}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Risk Exposure */}
        <Card className="col-span-1 lg:col-span-2"  style={{ background: "linear-gradient(to right, #cefae5, #ffffff)" }}>
          <CardHeader className="pb-2">
            <CardTitle className="text-lg font-bold">Risk Exposure</CardTitle>
          </CardHeader>
          <CardContent>
                ...
                {companyRisks.map((risk) => (
                  <div key={risk.id}>
                    <div className="flex justify-between items-start">
                      ...
                      <Badge
                        className={
                          risk.exposureLevel === "High"
                            ? "bg-red-100 text-red-800 border-red-200"
                            : risk.exposureLevel === "Medium"
        ...
        {/* Data Sources */}
        <Card className="col-span-1 border-t-8 border-t-green-400">
          <CardHeader className="pb-2">
            <CardTitle className="text-lg font-bold">Data Sources</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              {esgDataSources.map((source) => (
                <div
                  key={source.id}
                  className="flex items-center p-2 rounded hover:bg-gray-50 bg-slate-50"
                >
