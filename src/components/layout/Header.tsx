        ...
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden lg:flex items-center space-x-6">
            <Link
              ...
              className="flex items-center gap-1 text-gray-600 hover:text-finance-blue dark:text-gray-300 dark:hover:text-white font-medium transition-colors"
            >
          ...
          <nav className="lg:hidden mt-4 pb-2 border-t border-gray-200 dark:border-gray-700">
            <ul className="space-y-2 mt-2">
              <li>
                <Link
                  to="/investment-reports"
                  className="flex items-center gap-2 py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-md text-gray-600 dark:text-gray-300"
                >
